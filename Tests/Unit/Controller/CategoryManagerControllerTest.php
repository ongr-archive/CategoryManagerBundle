...
use ONGR\CategoryManagerBundle\Controller\CategoryManagerController;
...
class CategoryManagerControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testListAction()
    {
        ...
        $container->set('ongr_category_manager.category_manager', $manager);
    ...
    {
        return $this->getMockBuilder('ONGR\\CategoryManagerBundle\\Service\\CategoryManager')
            ->disableOriginalConstructor()
            ->getMock();
    }
