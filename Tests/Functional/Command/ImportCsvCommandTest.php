...
use Fox\CategoryManagerBundle\Command\ImportCsvCommand;
...
class ImportCsvCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $manager = $this->getMock('Fox\\CategoryManagerBundle\\Service\\TransferManager');
        ...
        $container->set('fox_category_manager.transfer_manager', $manager);
