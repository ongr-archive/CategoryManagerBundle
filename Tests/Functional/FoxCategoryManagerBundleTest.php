...
namespace Fox\CategoryManagerBundle\Tests\Functional;

use Fox\CategoryManagerBundle\FoxCategoryManagerBundle;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\Finder\Finder;

class FoxCategoryBundleTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testPassesRegistered()
    {
        ...
        $bundle = new FoxCategoryManagerBundle();
