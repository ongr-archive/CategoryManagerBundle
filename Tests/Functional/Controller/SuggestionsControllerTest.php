...
use Fox\CategoryManagerBundle\Controller\SuggestionsController;
use Fox\CategoryManagerBundle\Service\SuggestionsManager;
use Fox\CategoryManagerBundle\Tests\Integration\Iterator\DummyIterator;
...
class SuggestionsControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testListAction($request, $manager, $statusCode)
    {
        ...
        $container->set('fox_category_manager.suggestions_manager', $manager);
    ...
    {
        return $this->getMockBuilder('Fox\\CategoryManagerBundle\\Service\\SuggestionsManager')
            ->disableOriginalConstructor()
            ->getMock();
    }
}
