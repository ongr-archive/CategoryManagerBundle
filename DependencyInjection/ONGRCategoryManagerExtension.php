...
class ONGRCategoryManagerExtension extends Extension
{
    ...
    protected function injectDDAL($config, ContainerBuilder $container)
    {
        ...
        if (!empty($config['connection']['index_settings'])) {
            $settings = $container->getParameter('ongr_category_manager.node_model_connection.settings');
            ...
            $container->setParameter('ongr_category_manager.node_model_connection.settings', $settings);
        }

        $ddalConfig = $container->getParameter('ongr_ddal.model_map');
        $contentConfig = $container->getParameter('ongr_category_manager.ongr_ddal.model_map');
